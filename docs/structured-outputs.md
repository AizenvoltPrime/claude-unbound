...
For single API calls without tool use, see [API Structured Outputs](/docs/en/build-with-claude/structured-outputs). </Note>
...
- [TypeScript SDK reference](./agents-sdk.md) - Full TypeScript API
